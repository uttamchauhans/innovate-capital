...
CREATE TABLE "new_InterestRecord" (
    ...
    CONSTRAINT "InterestRecord_investmentId_fkey" FOREIGN KEY ("investmentId") REFERENCES "Investment" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_InterestRecord" ("clientId", "createdAt", "id", "interestReceived", "note", "profitCredited", "profitDay") SELECT "clientId", "createdAt", "id", "interestReceived", "note", "profitCredited", "profitDay" FROM "InterestRecord";
